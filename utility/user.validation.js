const bcrypt = require ('bcrypt') // Importacion de la libreria para encriptar las contrasenias
const User = require('../models/User') // Importacion del modelo de usuarios
...
const validateUserData = (username, email, password, avatar) => {
    ...
    if(!['avatar1.png', 'avatar2.png', 'avatar3.png', 'avatar4.png', 'avatar5.png', 'avatar6.png', 'avatar7.png', 'avatar8.png', 'avatar9.png', 'avatar10.png'].includes(avatar)) {
...
module.exports = {validateUserData, validateUserName, validatePassword, generateHashPassword}
