...
const { validateUserData, validateUserName, generateHashPassword, validatePassword } = require('../utility/user.validation');
...
const updateUser = async (req, res) => {
    try {
        ...
        const updatedUser = await User.findByIdAndUpdate(user.id, { username, password: modifyPassword }, { new: true, runValidators: true });
